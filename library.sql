...
CREATE TABLE `admin` (
  ...
  KEY `fk_admin_user1_idx` (`user_login`),
  CONSTRAINT `fk_admin_user1` FOREIGN KEY (`user_login`) REFERENCES `user` (`login`) ON DELETE CASCADE ON UPDATE RESTRICT
...
CREATE TABLE `book` (
  ...
  `publisher_isbn` int NOT NULL,
  `date` date DEFAULT NULL,
  `title` varchar(45) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_book_author_idx` (`author_id`),
  KEY `fk_book_publisher1_idx` (`publisher_isbn`),
  CONSTRAINT `fk_book_author` FOREIGN KEY (`author_id`) REFERENCES `author` (`id`),
  CONSTRAINT `fk_book_publisher1` FOREIGN KEY (`publisher_isbn`) REFERENCES `publisher` (`isbn`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `librarian` (
  `user_login` varchar(45) NOT NULL,
  PRIMARY KEY (`user_login`),
  KEY `fk_librarian_user1_idx` (`user_login`),
  CONSTRAINT `fk_librarian_user1` FOREIGN KEY (`user_login`) REFERENCES `user` (`login`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `reader` (
  ...
  PRIMARY KEY (`user_login`),
  KEY `fk_reader_user1_idx` (`user_login`),
  CONSTRAINT `fk_reader_user1` FOREIGN KEY (`user_login`) REFERENCES `user` (`login`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `reader_has_receipt` (
  `reader_user_login` varchar(45) NOT NULL,
  `receipt_id` int NOT NULL,
  PRIMARY KEY (`reader_user_login`,`receipt_id`),
  KEY `fk_reader_has_receipt_receipt1_idx` (`receipt_id`),
  KEY `fk_reader_has_receipt_reader1_idx` (`reader_user_login`),
  CONSTRAINT `fk_reader_has_receipt_reader1` FOREIGN KEY (`reader_user_login`) REFERENCES `reader` (`user_login`),
...
CREATE TABLE `subscription` (
  ...
  `book_id` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_loans_reader1_idx` (`reader_user_login`),
  KEY `fk_loans_book1_idx` (`book_id`),
  CONSTRAINT `fk_loans_book1` FOREIGN KEY (`book_id`) REFERENCES `book` (`id`),
  CONSTRAINT `fk_loans_reader1` FOREIGN KEY (`reader_user_login`) REFERENCES `reader` (`user_login`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-12-06 20:59:37
